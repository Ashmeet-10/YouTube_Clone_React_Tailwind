...
const VideoCard = (props) => {
  ...
  return (
    <div className='text-white cursor-pointer' onClick={()=>navigate(`/video/${props.videoId}`)} >
      ...
      <div className="flex items-center h-20 bg-[#0f0f0f]">
        <div className="channel-icon mx-2 flex justify-center items-center">
          ...
          {/* {props.Category && <img src={props.authorThumbnail[0].url} width="50px" height="50px" className='rounded-full' alt="" />} */}
        </div>
